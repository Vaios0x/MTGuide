...
if (!API_BASE_URL) {
  console.warn('Advertencia: No se ha definido VITE_API_URL. Las llamadas a la API usarán "/api" como baseURL. Si no tienes backend, las peticiones fallarán (pero el build funcionará).')
}
